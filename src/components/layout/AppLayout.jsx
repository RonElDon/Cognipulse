  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-indigo-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900 flex relative">
      ...
      <button
        ...
        className={`hidden md:flex fixed top-0 z-50 w-8 h-screen items-center justify-center bg-gradient-to-b from-slate-800 to-slate-900 dark:from-slate-900 dark:to-slate-950 text-white hover:from-slate-700 hover:to-slate-800 transition-all duration-300 ${sidebarOpen ? 'left-64' : 'left-0'}`}
